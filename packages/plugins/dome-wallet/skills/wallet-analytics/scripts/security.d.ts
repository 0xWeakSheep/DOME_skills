 ...
 */
export declare function sanitizeWalletData<T extends Record<string, unknown>>(data: T): T;
/**
 * Sanitize position data object
 */
export declare function sanitizePositionData<T extends Record<string, unknown>>(data: T): T;
/**
