 ...
 */
export function sanitizeMarketData(data) {
    ...
    for (const field of stringFields) {
        if (typeof sanitized[field] === 'string') {
            sanitized[field] = sanitizeString(sanitized[field], field === 'description' ? 2000 : 500);
        }
    }
    // Sanitize tags array
    if (Array.isArray(sanitized.tags)) {
        sanitized.tags = sanitizeStringArray(sanitized.tags, 50);
    }
    return sanitized;
}
/**
